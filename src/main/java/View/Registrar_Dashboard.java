...
import Controller.Registrar_Dashboard_Controller;

public class Registrar_Dashboard extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Registrar_Dashboard frame = new Registrar_Dashboard(null);
	...
	public Registrar_Dashboard(String email) {
		setEmail(email);
		...
		lbl_Background.setIcon(new ImageIcon(Registrar_Dashboard.class.getResource("/Resources/Background_Registrar.png")));
		...
		lbl_UserName = new JLabel("ARAVHEIYL B. FELICISIMO");
		...
		lbl_AdminRole.setForeground(new Color(0, 128, 0));
